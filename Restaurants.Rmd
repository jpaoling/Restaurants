...
To do: create violation groups...


Violation types overall and by boro:
...
Distribution of violation types seems to be consistent across boros (at first glance). Question: What are the most common types of violation?

```{r}
# Overall
(viol_df <- restaurants_raw %>% 
